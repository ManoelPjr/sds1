...
const CreateRecord = () => {
  ...
  useEffect(() => {
    axios.get(`${BASE_URL}/games`)
      .then(response => {
        const selelectValues = mapSelectValues(response.data);
        console.log(selelectValues);
        setAllGames(selelectValues);
      })
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        />
        <TextInput
          keyboardType="numeric" //corrigir depois teclado não sai
          style={styles.inputText}
          placeholder="Idade"
          placeholderTextColor="#9E9E9E"
          maxLength={3}
        ...
        <RNPickerSelect
          ...
          value={selectedGame} //tentar resolver esse warning depois
          items={filteredGames}
